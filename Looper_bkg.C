...
template <class classInst,class HistogramCreater> bool Looper_bkg<classInst,HistogramCreater>::OneTag(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_bkg<classInst,HistogramCreater>::TwoTag(TChain *tr,classInst& read,string ProcessName,int iEvent){
