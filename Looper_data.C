...
template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::OneTag(TChain *tr,classInst& read,string ProcessName,int iEvent){

return true;
}

template <class classInst,class HistogramCreater> bool Looper_data<classInst,HistogramCreater>::TwoTag(TChain *tr,classInst& read,string ProcessName,int iEvent){
